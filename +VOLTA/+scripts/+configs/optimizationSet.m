function [gaParams, plotParams] = optimizationSet(varParams)
%optimizationSet Define optimization parameter set for GA-based ADC optimization
%
...
% ------------------------------------------------------------------------
% varsInit = [100e3 50e6 0.4 10 0.7e6];
...
gaParams.EliteCount = 0.02 * gaParams.PopulationSize; % Keep 1-5% of population size

%% ------------------------------------------------------------------------
% Reproduction : Crossover
% -------------------------------------------------------------------------

gaParams.CrossoverFraction = 0.6;                  % Trades off diversity for fitness/convergence
